...
<nav class="border-gray-200 bg-gray-50 dark:bg-[#800000] dark:border-gray-700">
   ...
   <h2 class="text-2xl font-semibold mb-4">Daftar Admin Alonica</h2>
   <a href="add_admin.php" class="inline-block mb-4 px-6 py-2 bg-green-500 text-red-800 text rounded-md">Tambah Admin</a>
        <table class="table-auto w-full border-collapse border border-gray-300">
            <thead>
                <tr>
                    <th class="border px-4 py-2">ID Admin</th>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td class='border px-4 py-2'>" . $row['idadmin'] . "</td>";
                    echo "<td class='border px-4 py-2'>" . $row['nama'] . "</td>";
                    echo "<td class='border px-4 py-2'>" . $row['gmail'] . "</td>";
                    echo "<td class='border px-4 py-2'>" . $row['pass'] . "</td>";
                    echo "<td class='border px-4 py-2'>
                            <a href='edit_admin.php?id=" . $row['idadmin'] . "' class='text-blue-500'>Edit</a> | 
                            <a href='delete_admin.php?id=" . $row['idadmin'] . "' class='text-red-500' onclick='return confirm(\"Apakah Anda yakin ingin menghapus?\")'>Hapus</a>
                          </td>";
                    echo "</tr>";
                }
                ?>
